      ...
      },
      {
        ...
        gallery: {
          ...
          interior: [
            ...
            { src: '/images/models/mirage-recliners/interior-04.jpg', caption: 'Front queen bed with quilted mattress — gloss white overhead cabinetry, marble-look bedside tables, twin ceiling fans and reading lights overhead.' },
            { src: '/images/models/mirage-recliners/interior-05.jpg', caption: 'Galley wall — gloss white uppers, marble-look benchtop with under-bench oven and stainless sink, fridge and microwave tower on the right.' },
            { src: '/images/models/mirage-recliners/interior-06.jpg', caption: 'Ensuite — marble-look vanity with vessel basin, framed mirror, gloss white overhead cabinets and a cassette toilet alongside.' },
            { src: '/images/models/mirage-recliners/interior-07.jpg', caption: 'Bedroom from the foot of the bed — quilted mattress, twin reading-light fans on the ceiling, marble-look bedside tables and full-height bedside wardrobes.' },
            { src: '/images/models/mirage-recliners/interior-08.jpg', caption: 'Looking from the lounge toward the bed — twin black recliner chairs on the left, galley with fridge tower on the right, skylight overhead.' },
            { src: '/images/models/mirage-recliners/interior-09.jpg', caption: 'Shower stall — chrome hand-held with slide rail, glass door and bright white wet-wall panels with a non-slip base.' },
            { src: '/images/models/mirage-recliners/interior-10.jpg', caption: 'Twin recliner detail — black bucket seats, marble-look shared side-table and TV mount on the wall, Dometic cassette air-con overhead.' },
          ],
        },
      },
      {
